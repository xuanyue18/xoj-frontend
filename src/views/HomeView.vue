<template>
  <div id="Home">
    <div class="typewriter">
      <h1 class="typing">欢迎来到XCode OJ, Enjoy Coding And Get Happiness.</h1>
...
#Home {
  ...
  align-items: center;
  background-image: url("../assets/home_bg.svg"); /* 添加背景图片 */
  background-size: cover; /* 控制背景图片的大小 */
...
.typewriter .typing {
  ...
  border-right: 0.15em solid #035afd; /* 使用边框实现光标 */
  white-space: nowrap;
  margin-bottom: 32px;
